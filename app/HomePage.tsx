...
const services = [
  ...
  { num: "04", title: "AI-продакшн", text: "AI-контент, цифровые амбассадоры и внедрение нейросетей в бизнес.", result: "На выходе — технологии, которые ускоряют продакшн, и команда, которая ими владеет." },
];
