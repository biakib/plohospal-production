...
const services = [
  { num: "01", title: "Упаковка бренда", text: "Позиционирование, фирменный стиль и презентации, которые продают.", result: "На выходе — бренд с характером: от логотипа и брендбука до питч-дека." },
  { num: "02", title: "Стратегия и маркетинг", text: "Аудит медиаприсутствия, анализ аудитории и стратегия с понятными KPI.", result: "На выходе — не документ на полку, а живой инструмент роста бизнеса." },
  { num: "03", title: "SMM и контент", text: "Контент-стратегия, ведение аккаунтов и работа с блогерами.", result: "На выходе — медиаприсутствие, которое приводит клиентов." },
  { num: "04", title: "Продакшн: съёмка и сценарии", text: "Сценарии, съёмка видео и фото — под ключ, от идеи до публикации.", result: "На выходе — история и картинка, которая цепляет с первых секунд." },
  { num: "05", title: "AI-контент", text: "AI-фото и AI-видео, цифровые аватары, озвучка и клонирование голоса.", result: "На выходе — контент без студии и съёмочных дней: быстрее и дешевле." },
  { num: "06", title: "Внедрение и обучение ИИ", text: "Подбор ИИ-инструментов под процессы и обучение вашей команды.", result: "На выходе — команда, которая делает больше силами тех же людей." },
];
