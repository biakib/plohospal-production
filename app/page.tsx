...
const services = [
  ...
  { num: "02", title: "Контент", text: "Система контента: от идеи и сценария до публикации и аналитики.", result: "На выходе — контент-план, форматы и сценарии, которые можно запускать сразу." },
  { num: "03", title: "Продвижение", text: "SMM, рекламные кампании и присутствие там, где находится ваша аудитория.", result: "На выходе — рабочая воронка внимания и понятные метрики результата." },
  { num: "04", title: "AI-продакшн", text: "Цифровые амбассадоры, AI-аватары и инструменты нового поколения.", result: "На выходе — технологии, которые ускоряют продакшн и усиливают ваш образ." },
];
...
const team = [
  { name: "Илья Бушманов", role: "Основатель-идеолог", image: "/assets/ilya-bushmanov-new.png", links: [["ВК", "https://vk.com/bimperv"], ["TG", "https://t.me/bimperv"], ["IG", "https://www.instagram.com/bimperv"]] },
  { name: "Иван Егоров", role: "Креативный директор", image: "/assets/ivan-egorov-new.png", links: [["ВК", "https://vk.com/vanzep"], ["TG", "https://t.me/vanzep"], ["IG", "https://www.instagram.com/ivanegorov"]] },
  { name: "Денис Круглов", role: "Сценарист, оператор, режиссёр", image: "/assets/denis-kruglov-new.png", links: [["ВК", "https://vk.ru/motherfackers1"], ["IG", "https://www.instagram.com/kds_video_prod"]] },
  { name: "Артур Рякин", role: "Продюсер проектов", image: "/assets/artur-ryakin.png", links: [["ВК", "https://vk.ru/honeykut"]] },
  { name: "Илья Кузьмицкий", role: "Специалист по внедрению ИИ-технологий и обучению нейросетям", image: "/assets/ilya-kuzmitsky.png", links: [["ВК", "https://vk.ru/neuro_ilya"], ["TG", "https://t.me/Neuro_Ilya"]] },
  { name: "Лиона Филь", role: "Руководитель направления актёрского и ораторского мастерства", image: "/assets/liona-fil-portrait-v2.png", links: [["ВК", "https://vk.com/lionkas"], ["TG", "https://t.me/lionaelle"], ["IG", "https://www.instagram.com/lionaelle"]] },
  { name: "Юлия Гирш", role: "Специалист по AI и SMM", image: "/assets/yulia-girsh-new.png", links: [["ВК", "https://vk.com/id138925509"], ["TG", "https://t.me/@girshjuli"], ["IG", "https://www.instagram.com/juli_girsh"]] },
];
    ...
    <main>
      ...
      <section className="intro section" id="about">
        ...
        <div className="intro-grid">
          <div className="portrait"><img src="/assets/about.jpeg" alt="Команда PLOHOSPAL Production за работой"/></div>
      ...
      <section className="services section">
        <div className="section-label-row"><div className="eyebrow">[ Направления ]</div><a className="text-link" href="/directions">Все направления ↗</a></div>
      ...
      <section className="manifesto section">
        <div className="manifesto-art"><img src="/assets/manifesto.png" alt="Креативный образ PLOHOSPAL Production"/></div>
        <div className="manifesto-copy">
          ...
          <a className="dark-link" href="/manifesto">Читать манифест ↗</a>
        </div>
      </section>
      ...
      <section className="faq section">
        ...
        <div className="faq-grid"><h2>Перед тем,<br/>как начать</h2><div>
          ...
          <a className="text-link faq-more" href="/faq">Все вопросы и ответы ↗</a>
        </div></div>
      </section>
      <SiteFooter/>
    </main>
